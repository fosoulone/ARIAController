...
public class Action14Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button = ((Button) findViewById(R.id.a14_send_button));
        angle = ((EditText) findViewById(R.id.a14_angle));
                ...
                new View.OnClickListener() {
                    public void onClick(View view) {
                        try {
                            ...
                            task.execute("14;"+angle.getText().toString()+";",ip,""+port);
                        }catch(Exception e){

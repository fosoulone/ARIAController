...
public class Action15Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button = ((Button) findViewById(R.id.a15_send_button));
        distance = ((EditText) findViewById(R.id.a15_distance));
        angle = ((EditText) findViewById(R.id.a15_angle));
                ...
                new View.OnClickListener() {
                    public void onClick(View view) {
                        try {
                            ...
                            task.execute("15;"+distance.getText().toString()+";"+angle.getText().toString()+";",ip,""+port);
                        }catch(Exception e){

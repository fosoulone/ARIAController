...
public class Action13Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button = ((Button) findViewById(R.id.a13_send_button));
        distance = ((EditText) findViewById(R.id.a13_distance));
                ...
                new View.OnClickListener() {
                    public void onClick(View view) {
                        try {
                            ...
                            task.execute("13;"+distance.getText().toString()+";",ip,""+port);
                        }catch(Exception e){
